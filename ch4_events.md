...
# [1] Create class representing the Changing `EventArgs` to track
- a subclass of `System.EventArgs` (inherits it, a child of)
...
- [prior c#2.0] `public delegate void PriceChgHandler(object src, PriceChgEventArgs e)`
